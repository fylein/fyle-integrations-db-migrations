...
select 
    ...
    join expense_attributes ea on ea.id = cm.source_category_id
    join destination_attributes da on da.id = cm.destination_account_id
    join destination_attributes da2 on da2.id = cm.destination_expense_head_id
;
