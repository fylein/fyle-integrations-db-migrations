DROP FUNCTION if exists reset_location_entity_without_clearing_past_exports;

CREATE OR REPLACE FUNCTION reset_location_entity_without_clearing_past_exports(IN _workspace_id integer) RETURNS void AS $$
DECLARE
    rcount integer;
BEGIN
