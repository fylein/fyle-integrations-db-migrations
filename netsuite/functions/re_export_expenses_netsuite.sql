...
CREATE OR REPLACE FUNCTION re_export_expenses_netsuite(IN _workspace_id integer, _expense_group_ids integer[], trigger_export boolean DEFAULT false) RETURNS void AS $$
