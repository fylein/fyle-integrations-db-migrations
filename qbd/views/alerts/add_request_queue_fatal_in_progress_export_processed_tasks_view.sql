DROP VIEW IF EXISTS add_request_queue_fatal_in_progress_export_processed_tasks_view;

CREATE OR REPLACE VIEW add_request_queue_fatal_in_progress_export_processed_tasks_view AS 
WITH add_request_queue_fatal_in_progress_export_processed_tasks AS (
    SELECT COUNT(*) AS add_request_queue_fatal_in_progress_export_processed_tasks_count
